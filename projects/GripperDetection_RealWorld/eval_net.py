...
from detectron2.data.datasets.gripper_detection_real_world import register_all_real_world_gripper_detection
from detectron2.engine.defaults import default_argument_parser, default_setup
from detectron2.modeling import build_model
from detectron2.checkpoint import DetectionCheckpointer
from detectron2.utils.visualizer import Visualizer
from projects.GripperDetection_RealWorld.utils.build_trajs import build_trajectory
from projects.GripperDetection_RealWorld.utils.build_qwen2vl_dataset import build_dataset_entry, build_output_message, save_dataset
from projects.GripperDetection_RealWorld.utils.gen_traj_gifs import gen_traj_gifs


TRAINED_MODEL_PATH_CAM_1 = "/home/temp_store/troth/outputs/gripper_detection_real_world/models/2025_01_13-16_58_35/model_final.pth"
TRAINED_MODEL_PATH_CAM_2 = "/home/temp_store/troth/outputs/gripper_detection_real_world/models/2025_01_12-13_57_08/model_final.pth"
ROBOT_STATE_ANNOTATIONS_PATH = "/home/temp_store/troth/data/irl_kitchen_gripper_detection_real_world/robot_state_annotations/"
...
def setup_cfg(args):
    ...
    cfg = get_cfg()
    cfg.merge_from_file("projects/_RealWorld/configs/gripper_detection.yaml")
    cfg.freeze()
...
def main(args, save_bboxes=False, save_trajs=False, hide_past_traj=True, filter_no_gripper_detected=True, build_dataset=False, sequence=None):
    ...
    register_all_real_world_gripper_detection()
    ...
    if sequence == None:
        ...
        for cam_id in [1, 2]:
            ...
            for i in tqdm(range(NUM_SEQUENCES_ALL), total=NUM_SEQUENCES_ALL, desc=f"Building dataset for cam_{cam_id}" if build_dataset
                ...
                curr_sequence = f"gripper_detection_real_world_cam_{cam_id}_seq_{i:03d}"
...
if __name__ == "__main__":
    ...
    #main(args, save_bboxes=True, save_trajs=True, hide_past_traj=True, build_dataset=True, sequence="gripper_detection_real_world_cam_1_seq_050")
    #main(args, save_trajs=True, hide_past_traj=False, sequence="gripper_detection_real_world_cam_1_seq_042")
