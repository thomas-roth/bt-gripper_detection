...
from projects.GripperDetection_calvin.evaluation.multistep_sequences import get_sequences
from projects.GripperDetection_calvin.evaluation.utils import get_env_state_for_initial_condition, join_vis_lang, LangEmbeddings
    ...
    def on_validation_start(self, trainer: Trainer, pl_module: LightningModule) -> None:
        ...
        if self.env is None:
            ...
            try:
                ...
                from projects.GripperDetection_calvin.rollout.rollout import Rollout
